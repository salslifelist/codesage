...
- Unsupported notebook content is a manual-review warning, not a smell.
...
- Baseline notebook review targets one user-selected hotspot and its containing cell.
...
- Reanalyse candidates with the same deterministic pipeline and keep descriptive, directional and structural comparisons separate.
